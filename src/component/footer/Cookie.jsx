...
function Cookie() {
    ...
    return (
        <div className={`bg-slate-800 bg-opacity-50 backdrop-blur-sm w-[35rem] fixed flex flex-wrap gap-4 justify-evenly items-center
                        left-[50%] -translate-x-[50%] bottom-10 p-3 rounded-lg z-10 ${ visible ? "opacity-100" : "opacity-0 transition-opacity duration-500 animate-hide-on [animation-fill-mode:forwards]" }
                        sm:w-full`}>
