...
export const PriceOfferIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="green" className="w-12 h-12">
...
export const EmailIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" stroke="red" strokeWidth={.6} viewBox="0 0 48 48" className="h-6 w-6">
