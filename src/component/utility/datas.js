...
export const metaDatas = {
    home: {
        ...
        description: "Lakásfelújítás munkálatok után érdeklődsz mint Szobafestés, Mázolás, Gipszkartonozás, Tapétázás akkor jó helyen jársz."
    },

    services: {
        title: "Lakásfelújítás Szolgáltatásaim - Szobafestés, Mázolás, Tapétázás, Gipszkartonozás - Geringer János",
    ...
    paint: {
        ...
        description: "Szobafestésről minden, amit tudni érdemes, szobafestés lépései, üzlet festés, külső homlokzat festés - árak"
    },

    daub: {
        title: "Mázolás - Geringer János",
        description: "Mázolásról amit tudni érdemes ajtók, ablakok, nyilászárók mázolása - árak"
    },

    paperHanging: {
        title: "Tapétázás - Geringer jános",
        description: "Tapétázás ragasztással, amit tudni érdemes, dísztapéta rakás- árak"
    },

    plasterBoarding: {
        title: "Gipszkartonozás, Profilozás - Geringer János",
        description: "Minden, amit a gipszkartonozásról tudni érdemes, álmennyezet, oldalfal, válaszfal gipszkartonozás - árak"
    }
}
...
export const paintingDatas = {
    'Előkészület a festéshez': {
        ...
        "Glettelés": "Sima felület létrehozásához elengedhetetlen a glettelés, faltól függ, hogy hány rétegbe glettelünk.",
        "Tapétázás": "Nem kötelező, de tapétát is rakhatunk a falra festés előtt, ez a plusz réteg akár szebbé teheti a felületet."     
    },
